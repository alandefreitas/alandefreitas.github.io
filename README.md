...
| `assets/favicon.svg`, `assets/favicon.ico`, `assets/apple-touch-icon.png` | The tab icon (EB Garamond A, white on navy, SVG with a 48/32/16 ico fallback) and the touch icon (the portrait, 180px). Sources and the candidate study live in the Strategy brand folder. |
